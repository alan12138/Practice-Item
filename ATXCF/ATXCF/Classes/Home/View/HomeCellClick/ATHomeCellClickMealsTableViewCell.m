//
//  ATHomeCellClickMealsTableViewCell.m
//  ATXCF
//
...
@interface ATHomeCellClickMealsTableViewCell ()
...
@implementation ATHomeCellClickMealsTableViewCell
- (void)setHomeCellClickMeals:(ATHomeCellClickMeals *)homeCellClickMeals {
    _homeCellClickMeals = homeCellClickMeals;
    
    [self.menuImageView setMainImageURL:[NSURL URLWithString:homeCellClickMeals.recipe.photo]];
    
    if (homeCellClickMeals.recipe.is_exclusive) {
        self.markLabel.hidden = NO;
    } else {
        self.markLabel.hidden = YES;
    }
    self.titleLabel.text = homeCellClickMeals.recipe.name;
    
    [self.userIconImageView setMainImageURL:[NSURL URLWithString:homeCellClickMeals.recipe.author.photo]];
    
    self.userNameLabel.text = homeCellClickMeals.recipe.author.name;
    
    if (homeCellClickMeals.recipe.score.length) {
        self.scoreLabel.text = [NSString stringWithFormat:@"%@分", homeCellClickMeals.recipe.score];
    ...
    self.personNumLabel.text = [NSString stringWithFormat:@"%@人做过", homeCellClickMeals.recipe.stats.n_cooked];
    
    if (homeCellClickMeals.reason.length) {
        [self.contentView addSubview:self.campaignLabel];
        self.campaignLabel.text = homeCellClickMeals.reason;
